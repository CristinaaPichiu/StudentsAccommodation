...
import database.repository.Validation;
...
public class StudRegistrationFrame extends JFrame {
    ...
    private void settingSerialNumber(int posX, int posY) {
        settingLabels(posX - 8, posY - 8, 200, 29, "Student ID Number");
    ...
    private void settingGpa(int posX, int posY) {
        settingLabels(posX, posY, 110, 29, "Score");
    ...
    public StudRegistrationFrame() {
        ...
        btnNewButton.addActionListener(e -> {
            ...
            Validation validationDataRepository = new Validation(lastName, firstName, year, group, emailAddr, serialNumber, gpa, dob, femaleGender, maleGender);
            try {
